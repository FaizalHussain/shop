...
<div id="special_block_right" class="block products_block exclusive blockspecials">
	<div class="title_block"><a href="{$link->getPageLink('prices-drop')|escape:'html'}" title="{l s='Specials' mod='blockspecials'}">{l s='Specials' mod='blockspecials'}</a></div>
	<div class="block_content">

{if $special}
		<ul class="products clearfix">
			<li>
				<a class="product_image" href="{$special.link|escape:'html'}"><img src="{$link->getImageLink($special.link_rewrite, $special.id_image, 'medium_default')|escape:'html'}" alt="{$special.legend|escape:html:'UTF-8'}" height="{$mediumSize.height}" width="{$mediumSize.width}" title="{$special.name|escape:html:'UTF-8'}" /></a>
				{if !$PS_CATALOG_MODE}
