...
<div id="new-products_block_right" class="block products_block">
	<div class="title_block"><a href="{$link->getPageLink('new-products')|escape:'html'}" title="{l s='New products' mod='blocknewproducts'}">{l s='New products' mod='blocknewproducts'}</a></div>
	...
	{if $new_products !== false}
		...
		{foreach from=$new_products item=newproduct name=myLoop}
			<li class="clearfix {if $smarty.foreach.myLoop.first}first_item{elseif $smarty.foreach.myLoop.last}last_item{else}item{/if}">
                        <a class="title" href="{$newproduct.link|escape:'html'}" title="{$newproduct.name|escape:html:'UTF-8'}">{$newproduct.name|strip_tags|escape:html:'UTF-8'}</a>
		...
		<p><a href="{$link->getPageLink('new-products')|escape:'html'}" title="{l s='All new products' mod='blocknewproducts'}">&raquo; {l s='All new products' mod='blocknewproducts'}</a></p>
	{else}
