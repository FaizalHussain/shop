...
<div id="favoriteproducts_block_account">
	...
	{if $favoriteProducts}
		<div>
			...
			<div class="favoriteproduct clearfix">
				...
				<div class="remove">
					<img rel="ajax_id_favoriteproduct_{$favoriteProduct.id_product}" src="{$img_dir}icon/delete.png" alt="" class="icon" />
				</div>
			</div>
			{/foreach}
		</div>
	...
	<ul class="footer_links">
		<li class="fleft">
			<a href="{$link->getPageLink('my-account', true)|escape:'htmlall':'UTF-8'}"><img src="{$img_dir}icon/my-account.png" alt="" class="icon" /></a>
