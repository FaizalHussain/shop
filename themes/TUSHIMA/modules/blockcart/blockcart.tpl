	...
	{/if}
				...
				<tr class="bloc_cart_voucher" id="bloc_cart_voucher_{$discount.id_discount}">
					...
					<td class="delete">
						{if strlen($discount.code)}
							<a class="delete_voucher" href="{$link->getPageLink('$order_process', true)}?deleteDiscount={$discount.id_discount}" title="{l s='Delete' mod='blockcart'}" rel="nofollow"><img src="{$img_dir}icon/delete.png" alt="{l s='Delete' mod='blockcart'}" class="icon" /></a>
						{/if}
					</td>
				</tr>
				{/if}
		...
		<p id="cart-buttons">
			...
			<a href="{$link->getPageLink("$order_process", true)|escape:'html'}" id="button_order_cart" class="exclusive{if $order_process == 'order-opc'}_large{/if}" title="{l s='Check out' mod='blockcart'}" rel="nofollow"><span></span>{l s='Check out' mod='blockcart'}</a>
                        <a href="" id="block_cart_close" rel="nofollow"><img src="{$img_dir}closeup.png"/></a>
		</p>
	</div>
	</div>
</div>
