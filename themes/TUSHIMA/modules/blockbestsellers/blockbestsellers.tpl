...
<div id="best-sellers_block_right" class="block products_block">
	<div class="title_block"><a href="{$link->getPageLink('best-sales')|escape:'html'}">{l s='Top sellers' mod='blockbestsellers'}</a></div>
	...
	{if $best_sellers|@count > 0}
		...
		<p><a href="{$link->getPageLink('best-sales')|escape:'html'}" title="{l s='All best sellers' mod='blockbestsellers'}">&raquo; {l s='All best sellers' mod='blockbestsellers'}</a></p>
	{else}
