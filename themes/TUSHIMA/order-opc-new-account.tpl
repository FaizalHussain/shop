<div id="opc_new_account" class="opc-main-block">
	...
	<form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html'}" method="post" id="login_form" class="std formStyle">
		<fieldset>
	...
	<form action="javascript:;" method="post" id="new_account_form" class="std formStyle" autocomplete="on" autofill="on">
		<fieldset>
